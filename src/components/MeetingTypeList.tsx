...
//           handleClick={() => setMeetingState('isJoiningMeeting')} className="bg-purple-1"
//         />
//         <HomeCard img="/icons/join-meeting.svg" title="Join Meeting" description="via inviatation link"
//           handleClick={() => router.push('/recordings')} className="bg-yellow-1"
//         />
